  ...
  _createClass(LabelValueMetadata, [{
    ...
    function render() {
      ...
      return /*#__PURE__*/_jsx("dl", {
        ...
        children: labelValuePairs.reduce(function (acc, labelValuePair, i) {
          return acc.concat([/*#__PURE__*/_jsx(Typography, {
            component: "dt",
            variant: "subtitle2",
            children: labelValuePair.label || defaultLabel
          }, "label-".concat(i)), /*#__PURE__*/_jsx(Typography, {
            style: {
              marginBottom: '.5em',
              marginLeft: '0px'
            },
