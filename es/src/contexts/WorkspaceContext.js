 ...
 */
export var withWorkspaceContext = function withWorkspaceContext(Component) {
  /**
  ...
  function ContextHoc(props, ref) {
    ...
    var _useState = useState(),
      ...
      workspaceRef = _useState2[0],
      setWorkspaceRef = _useState2[1];
    useEffect(function () {
  ...
  var whatever = /*#__PURE__*/forwardRef(ContextHoc);
  whatever.displayName = "WithWorkspaceContext(".concat(Component.displayName || Component.name || 'Component', ")");
  return whatever;
};
